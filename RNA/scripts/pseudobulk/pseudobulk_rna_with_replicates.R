...
#   args$metadata <- sprintf("/data/louisc/Project_Babraham/RNA/clustering/cluster_neighclust%s_res%s_nodiff/sample_metadata_after_clustering.txt.gz",
#                            args$n_neighbors_clusters,args$resolution)
# } else {
#   args$metadata <- sprintf("/data/louisc/Project_Babraham/RNA/clustering/cluster_neighclust%s_res%s/sample_metadata_after_clustering.txt.gz",
#                            args$n_neighbors_clusters,args$resolution)
#   
# }
...
# args$seed1 <- 42
# args$outdir <- file.path(sprintf("/data/louisc/Project_Babraham/RNA/pseudobulk/%s",args$group_by))
# END TEST ##
