...
## START TEST ##
# args$metadata <- "/data/louisc/Project_Babraham/RNA/qc/sample_metadata_after_cellstate.txt.gz"
# args$doublet_files <- "/data/louisc/Project_Babraham/RNA/mapping/doublets_all_1.25.txt.gz"
# args$outfile <- "/data/louisc/Project_Babraham/RNA/mapping/sample_metadata_after_doublets.txt.gz"
## END TEST ##
