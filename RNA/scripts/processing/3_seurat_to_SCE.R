...
## START TEST ##
# args <- list()
args$outfile <- "/kyukon/data/gent/courses/2024/design_project_C003698/groups/group01/RNA/SingleCellExperiment.rds"
...
sce <- computeSumFactors(sce, clusters = clusts, sizes = new_sizes, max.cluster.size = 3000) # added positive = TRUE for negative values
