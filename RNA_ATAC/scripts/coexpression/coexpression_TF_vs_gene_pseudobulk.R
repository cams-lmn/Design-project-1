...
source("/data/louisc/Project_Babraham/RNA_ATAC/scripts/Settings.R")
...
# # START TEST ##
# args <- list()
# args$sce <- "/data/louisc/Project_Babraham/RNA_ATAC/pseudobulk/cluster/RNA/pseudobulk_with_replicates.rds"
# args$TFs_file <- "/data/louisc/Project_Babraham/TFs.txt" # "/Users/argelagr/data/mm10_regulation/TFs/TFs.txt"
# args$cor_test <- "pearson"
# args$outdir <- "/data/louisc/Project_Babraham/RNA_ATAC/coexpression/pseudobulk/"
# # END TEST ##
