...
# args["outdir"] = "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/insilico_KO/"
...
for i in range(1,4):
    ...
    for gene in TFs:
        ...
        fig.savefig(args['outdir'] + "Insilio_KO_" + gene + "_flow" + args["suffix"])
        ...
        plt.savefig(args['outdir'] + "Insilio_KO_" + gene + "_flow_col" + args["suffix"])
