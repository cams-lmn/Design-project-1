...
args <- list()
args$interaction_table <-  "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/trajectories/N2P/sign/marker_TF/fig/Score0.06_Coef0.25/table_interactions.txt"
args$outdir <- "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/trajectories/N2P/sign/marker_TF/Interaction_plots/Score0.06_Coef0.25"
# # END TEST
