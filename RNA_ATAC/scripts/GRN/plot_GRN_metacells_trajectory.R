...
# args$grn_coef <- "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_networks/metacells/trajectories/N2P/global_chip_GRN_coef_score0.06.txt.gz"
# args$trajectory_name <- "N2P"
# args$TFs_to_plot <- "/data/homes/louisc/Project_Babraham/RNA_ATAC/chromvar_chip/GRN_TFs_to_plot.txt"
# args$grn_coef <- "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/trajectories/N2P/global_chip_GRN_coef.txt.gz"
# args$outdir <-  "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/trajectories/N2P/alt3/marker_TF/fig"
# args$min_coef <- 0.25
# args$max_pval <- 0.10
