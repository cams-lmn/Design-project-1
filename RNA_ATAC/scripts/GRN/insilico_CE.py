...
## START TEST ##
# args = {}
# args["anndata"] = "/data/homes/louisc/Project_Babraham/RNA_ATAC/metacells/anndata_metacells_nodiff.h5ad"
...
# args["outdir"] = "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/insilico_CE/"
# args["incl_samples"] = "nodiff"
# args["min_chip_score"] = 0.15
# args["max_distance"] = 50000
# args["marker_TFs_dir"] = "/data/homes/louisc/Project_Babraham/RNA_ATAC/pseudobulk/cluster/RNA/Marker_TF/"
# args['tf2gene'] = "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/CISBP/TF2gene_after_virtual_chip.txt.gz"
...
for i in range(1,4):
    ...
    for gene in TFs:
        ...
        #
        cutoff_1fold = float(sc.pp.log1p(max_expr["max_expr"][max_expr["gene"] == gene]))
        print("cutoff is " + str(cutoff_1fold))
        oracle.simulate_shift(perturb_condition={gene: cutoff_1fold}, n_propagation=3)
        #
        ...
        fig.savefig(args['outdir'] + "Insilio_CE_" + gene + "_flow" + args["suffix"])
        #
        ...
        plt.savefig(args['outdir'] + "Insilio_CE_" + gene + "_flow_col" + args["suffix"])
