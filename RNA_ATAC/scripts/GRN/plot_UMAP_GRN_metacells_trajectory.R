...
# args$rna_pseudobulk_sample.sce <- "/data/homes/louisc/Project_Babraham/RNA_ATAC/pseudobulk/batch/SingleCellExperiment_pseudobulk.rds"
# args$grn_coef <- "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/trajectories/N2P/alt3/global_chip_GRN_coef_alt2_score0.06.txt.gz"
# args$min_coef <- 0.25
...
# args$outdir <- "/data/homes/louisc/Project_Babraham/RNA_ATAC/gene_regulatory_network/metacells/trajectories/N2P/alt3/marker_TF/UMAP_fig"
