...
opts$celltype.colors <- c(
  "#A6CEE3",  # Immune 1 (light blue)
  "#1F78B4",  # Immune 2 (medium blue)
  "#08306B",  # Immune 3 (dark blue)

  "#B2DF8A",  # Stromal 4 (light green)
  "#238B45",  # Stromal 5 (dark green)

  "#E31A1C",  # Tumor 6 (red)
  "#FFFFFF"   # NA/unassigned 7 (white)
)
