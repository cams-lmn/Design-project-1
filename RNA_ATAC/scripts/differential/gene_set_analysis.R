...
for (i in 1:6){
  ...
  enrichResult_MF <- WebGestaltR(enrichMethod="ORA", organism = "mmusculus",
  ...
  enrichResult_BP <- WebGestaltR(enrichMethod="ORA", organism = "mmusculus",
  ...
  enrichResult_CC <- WebGestaltR(enrichMethod="ORA", organism = "mmusculus",
  ...
  enrichResult_KEGG <- WebGestaltR(enrichMethod="ORA", organism = "mmusculus",
