...
# args$outdir <- "/data/louisc/Project_Babraham/ATAC/archR/results/atac/archR/gene_scores"
# args$genome <- "hg38"
# args$threads <- 1
## END TEST ##
...
file.create("/data/homes/louisc/Project_Babraham/ATAC/archR/addGeneScoreMatrix_completed.txt")
