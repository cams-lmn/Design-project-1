...
## START TEST ##
# args <- list()
# args$gene_metadata <- "/data/louisc/Project_Babraham/Hsapiens_genes_BioMart.87.txt"
...
# args$outdir <- "/data/louisc/Project_Babraham/ATAC/archR/PeakCalls/peaks2genes"
## END TEST ##
